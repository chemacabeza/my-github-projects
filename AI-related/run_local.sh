...
download_model 'https://civitai.com/api/download/models/2905941' "$LORA_DIR/emma_lora.safetensors"
...
download_model 'https://civitai.com/api/download/models/2676941' "$LORA_DIR/aaju_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2694529' "$LORA_DIR/tina_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2697743' "$LORA_DIR/nora_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2700775' "$LORA_DIR/anna_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2703173' "$LORA_DIR/dalia_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2706444' "$LORA_DIR/olena_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2705922' "$LORA_DIR/zoya_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2709407' "$LORA_DIR/priya_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2711709' "$LORA_DIR/valentina_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2724940' "$LORA_DIR/carmen_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2727706' "$LORA_DIR/naran_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2748594' "$LORA_DIR/olga_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2780416' "$LORA_DIR/gabriela_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2784882' "$LORA_DIR/alina_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2805114' "$LORA_DIR/charlize_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2854321' "$LORA_DIR/dilnoza_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2901249' "$LORA_DIR/elif_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2903847' "$LORA_DIR/marie_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2906595' "$LORA_DIR/hildur_lora.safetensors"
