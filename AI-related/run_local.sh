...
download_model 'https://civitai.com/api/download/models/2567306' "$LORA_DIR/inga_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2526076' "$LORA_DIR/mariam_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2567275' "$LORA_DIR/chen_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2567351' "$LORA_DIR/iuliia_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2567333' "$LORA_DIR/allison_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2554575' "$LORA_DIR/emma_lora.safetensors"
download_model 'https://civitai.com/api/download/models/2567318' "$LORA_DIR/rabab_lora.safetensors"
