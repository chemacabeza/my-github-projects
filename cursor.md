...
- The project includes 34 LoRA models (5 standard + 29 custom character LoRAs). The latest addition is **olena** (Ukrainian, 24 years old, 1.72m tall, SDXL LoRA, model version ID 2706444).
